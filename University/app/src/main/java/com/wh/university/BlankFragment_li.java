...
public class BlankFragment_li extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view1= inflater.inflate(R.layout.fragment_blank_li, container, false);
        ll_university_list = view1.findViewById(R.id.ll_university_list_li);
